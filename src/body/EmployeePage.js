...
// import { getUsers, deleteUser } from './dataStore';
...
//                                 {/* <button onClick={() => handleEditUser(employee.id)} className="btn btn-primary">Edit</button> */}
//                             </div>
//                         </div>
//                     ))}
//                 </div>
...
//                     <input type="text" name="team" defaultValue={employee.team} />
//                     <input type="text" name="sex" defaultValue={employee.sex} />
